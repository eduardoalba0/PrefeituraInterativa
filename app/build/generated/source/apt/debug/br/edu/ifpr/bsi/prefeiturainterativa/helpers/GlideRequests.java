...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof br.edu.ifpr.bsi.prefeiturainterativa.helpers.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new br.edu.ifpr.bsi.prefeiturainterativa.helpers.GlideOptions().apply(toSet));
    }
  }
}
