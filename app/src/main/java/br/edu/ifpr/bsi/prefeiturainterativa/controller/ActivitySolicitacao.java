...
public class ActivitySolicitacao extends FragmentActivity implements StepperLayout.StepperListener {
    ...
    public void initStepper() {
        ...
        adapter.addFragment(new FragmentSolicitacaoCategoria(), getString(R.string.str_titulo_categoria));
    ...
    public <T> void chamarActivity(Class<T> activity) {
        Intent intent = new Intent(ActivitySolicitacao.this, activity);
        intent.putExtra("Tab", 2);
        ActivityOptionsCompat options = ActivityOptionsCompat.
                makeSceneTransitionAnimation(ActivitySolicitacao.this, stepperLayout, "splash_transition");
