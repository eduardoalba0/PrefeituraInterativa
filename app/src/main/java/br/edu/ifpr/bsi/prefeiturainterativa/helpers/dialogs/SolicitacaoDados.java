...
public class SolicitacaoDados extends Fragment implements View.OnClickListener {

    public Solicitacao solicitacao;

    public SolicitacaoDados(Solicitacao solicitacao) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_solicitacao_dados, container, false);
